...
function Thread( { user, thread, setShowPopUp, getThreads } ) {
  ...
  return (
    <article className="feed-card">
      ...
      <p>
        <span onClick={()=>setShowPopUp(true)}>X replies</span> ⋆
